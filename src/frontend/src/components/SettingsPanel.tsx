            ...
            <div className="mx-3 mt-3 bg-green-500 rounded-md p-3 bg-opacity-20">
                <form class="w-full max-w-lg">
                    <div class="flex items-center mb-4">
                        ...
                        <label
                            for="email-checkbox"
                            class="whitespace-nowrap mx-2 font-medium text-gray-900"
                        >
                            Send weekly email
                        </label>
                    ...
                    <div class="flex items-center mb-4">
                        ...
                        <div className="text-sm font-light text-gray-900">
                            Save palylist automatically at Sunday xx:xx UTC.
                            Service need to play one of playlist songs to get
                            playlist context
                        </div>
                    </div>
                </form>
